...
_1              lda #3                  ; Track Hyperwarp Target Marker (PLAYER3)
                ...
                .frsRandomByte          ; Prep random number
...
_3              .frsRandomByte          ; Prep random x-velocity of Hyperwarp Target Marker
                ...
                .frsRandomByte          ; Prep random y-velocity of Hyperwarp Target Marker
                ora #$10                ; Velocity value >= 16 <KM/H>
                and VEERMASK            ; Limit velocity value by mission level
...
INITTRAIL       .proc
                ...
                .frsRandomByte          ; Calc random index to pick initial star coordinates
                and #$03                ;
                tay                     ;
