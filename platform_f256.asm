...
;   set player sprites (sprite-00 & sprint-01)
                .frsSpriteInit PLSHAP2TAB, scEnable|scLUT0|scDEPTH0|scSIZE_16, 0
                .frsSpriteInit PLSHAP2TAB, scEnable|scLUT1|scDEPTH0|scSIZE_16, 1

;   set bomb sprites (sprite-02 & sprint-03)
                .frsSpriteInit PLSHAP1TAB, scEnable|scLUT0|scDEPTH0|scSIZE_16, 2
                .frsSpriteInit PLSHAP1TAB, scEnable|scLUT0|scDEPTH0|scSIZE_16, 3
